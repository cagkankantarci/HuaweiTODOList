...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        defineLayout();
        fabClass = new FabClass(getContext(),getActivity(),mDataSet,mDataSet2,mRecyclerView,"0",new HomeFragment());
    ...
    public void defineLayout()
    {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.allListRecyclerView);
