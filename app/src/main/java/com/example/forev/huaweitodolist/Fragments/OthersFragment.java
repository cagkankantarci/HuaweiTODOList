...
public class OthersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        define();
        fabClassCategory = new FabClassCategory(getContext(),getActivity(),mDataSet,mDataSet2,othersRecyclerView,new OthersFragment(),id);
    ...
    public void define()
    {
        ...
        othersRecyclerView = (RecyclerView)view.findViewById(R.id.othersRecyclerView);
