...
public class TravelFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        define();
        fabClassCategory = new FabClassCategory(getContext(),getActivity(),mDataSet,mDataSet2,travelRecyclerView,new TravelFragment(),id);
    ...
    public void define()
    {
        ...
        travelRecyclerView = (RecyclerView)view.findViewById(R.id.travelRecyclerView);
