...
public class ShoppingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        define();
        fabClassCategory = new FabClassCategory(getContext(),getActivity(),mDataSet,mDataSet2,shoppingRecyclerView,new ShoppingFragment(),id);
    ...
    public void define()
    {
        ...
        shoppingRecyclerView = (RecyclerView)view.findViewById(R.id.shoppingRecyclerView);
